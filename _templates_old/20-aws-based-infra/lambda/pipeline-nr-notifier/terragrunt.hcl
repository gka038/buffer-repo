...
terraform {
  source = "git@github.com:spryker-projects/tfcloud-modules.git//refactored/lambda/newrelic_notificator?ref=v8.0.0"
}
...
inputs = {
  ...
  newrelic_account_id            = local.newrelic.locals.newrelic_metrics_account_id
  newrelic_ingest_key            = local.newrelic.locals.newrelic_metrics_ingest_key

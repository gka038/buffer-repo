...
terraform {
  source = "git@github.com:spryker-projects/tfcloud-modules.git//refactored/spryker_variables?ref=v8.0.0"
}
...
inputs = {
  ...
  spryker_variables = {
    ...
    "NEWRELIC_LICENSE"                       = local.newrelic.locals.newrelic_integration.newrelic_apm_license_key

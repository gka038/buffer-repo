...
terraform {
  source = "git@github.com:spryker-projects/tfcloud-modules.git//refactored/ec2/scheduler?ref=v8.0.0"
}
...
inputs = {
  ...
  newrelic_license_key   = local.newrelic.locals.newrelic_integration.newrelic_apm_license_key

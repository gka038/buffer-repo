...
inputs = {
  ...
  autostart_pipeline         = local.spryker.locals.scheduler_type == "ecs" ? local.codepipelines_ecs.locals.codepipelines_config.maintenance_enable.autostart_pipeline : local.codepipelines_ec2.locals.codepipelines_config.maintenance_enable.autostart_pipeline

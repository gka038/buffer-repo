...
terraform {
  source = "git@github.com:spryker/tfcloud-modules.git//refactored/codepipeline_notifications?ref=23_02.0"
}
...
inputs = {
  ...
  opsgenie_api_key                          = dependency.vault_secrets.outputs.spryker_secrets["opsgenie_aws_codepipeline_failure"]

...
inputs = {
  ...
  autostart_pipeline         = local.spryker.locals.scheduler_type == "ecs" ? local.codepipelines_ecs.locals.codepipelines_config.build.autostart_pipeline : local.codepipelines_ec2.locals.codepipelines_config.build.autostart_pipeline

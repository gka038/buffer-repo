  ...
  codebuild_projects_config = {
    "pre_deploy_config" = {
      ...
      secondary_sources = {
        ...
        location          = "${dependency.s3.outputs.internal_s3_bucket_name}${local.codebuild-project.locals.codebuild_projects_config.pre_deploy_config.secondary_sources.location_suffix}"
      }
      tags = {}
    }
  }

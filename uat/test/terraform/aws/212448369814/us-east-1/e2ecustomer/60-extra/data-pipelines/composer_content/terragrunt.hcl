...
terraform {
  source = "git@github.com:spryker/tfcloud-modules.git//refactored/lambda/composer_content?ref=23_02.0"
}
...
inputs = {
  ...
  retro_rule_schedule_expression                   = local.composer_content.locals.retro_rule_schedule_expression 
  ...
  lambda_spryker_source_bucket_name                = dependency.s3.outputs.internal_s3_bucket_name

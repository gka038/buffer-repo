...
terraform {
  source = "git@github.com:spryker/tfcloud-modules.git//refactored/lambda/gmv?ref=23_02.0"
}
...
inputs = {
  ...
  retro_rule_schedule_expression                   = local.gmv.locals.retro_rule_schedule_expression

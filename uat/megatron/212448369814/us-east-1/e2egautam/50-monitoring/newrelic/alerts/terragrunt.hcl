...
terraform {
  source = "git@github.com:spryker-projects/tfcloud-modules.git//refactored/newrelic?ref=development"
}
...
inputs = {
  ...
  newrelic_integration            = merge(local.newrelic.locals.newrelic_integration,
  {

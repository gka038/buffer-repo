...
terraform {
  source = "git@github.com:spryker-projects/tfcloud-modules.git//refactored/ssm_patch_manager?ref=development"
}
...
inputs = {
  ...
  ssm_s3_bucket_name            = dependency.s3.outputs.ssm_s3_bucket_name

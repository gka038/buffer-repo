...
terraform {
  source = "git@github.com:spryker-projects/tfcloud-modules.git//refactored/lambda/backup_notifier?ref=23_01.0"
}
...
dependency "rds" {
  ...
  mock_outputs = {
    rds_backup_notifier_lambda_role_arn     = "arn:aws:iam::123456789012:mock"
